...
ciphered_image = ""
for sequence in split_text(binary_picture):
    ciphered_image += mini_des(sequence, input_key, input_permutation, sbox_1, sbox_2)

ciphered_image = fill_padding(ciphered_image, width, height)
write_picture('ciphed_ECB.pbm', width, height, ciphered_image)
