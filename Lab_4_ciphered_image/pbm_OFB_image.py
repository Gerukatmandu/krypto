...
for part in splitted_binary_picture:
    first_block = mini_des(first_block, input_key, input_permutation, sbox_1, sbox_2)
    ciphered_image.append( find_xor(part, first_block) )

ciphered_image = "".join(ciphered_image)

ciphered_image = fill_padding(ciphered_image, width, height)
write_picture('ciphed_OFB.pbm', width, height, ciphered_image)
